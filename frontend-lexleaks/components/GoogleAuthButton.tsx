      ...
      <div className={`flex items-center gap-3 ${className}`}>
        ...
        {user.is_admin && (
          <Link
            ...
            className="px-3 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors duration-200"
          >
            Admin Panel
          </Link>
        )}
  ...
  return (
    <div className={className}>
      <button
        ...
        disabled={loading}
        className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 rounded-md transition-colors duration-200"
      >
        {loading ? (
          <>
